...
src/                 // this is where your application code lives
    Application/     // the main module
        ...
        ApplicationView.js
        Content/                        // this folder only has modules within it, but it not a module by itself. You can create this folders if it helps you organise the project
            Articles/
                assets/
                    css/
                    img/
...
Keeping this is mind, Spoon.js does not offer a solution for the Model in its core, although it will be providing a few libraries that you could use. This gives you full flexibility on how to implement the Model. You can either use one of the libraries we provide, implement your own, or simply use some SDK that have been provided.
